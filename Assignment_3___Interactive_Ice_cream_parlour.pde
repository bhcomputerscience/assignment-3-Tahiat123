...
final int buttonY = 90; // Y position for all flavour buttons
...
if (hasSprinkles) {
  fill(255, 192, 203); // pastel pink
  rect(width/2 - 15, 220, 5, 10);
  fill(173, 216, 230); // pastel blue
  rect(width/2 + 10, 210, 5, 10);
  fill(255, 255, 150); // pastel yellow
  rect(width/2, 215, 5, 10);
  fill(144, 238, 144); // pastel green
  rect(width/2 - 5, 205, 5, 10);
  fill(255, 182, 193); // pastel pink again
